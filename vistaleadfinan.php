...
if(!check_session()){
  ...
  if($_SESSION['permisosUsuario'] != "Financiero") {
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
                    ...
                    <form id="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <input id="idFin" type="hidden" value=""/>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="FinanAprobado" class="btn btn-success">Aprobado</button>  
                          <button id="FinanRechazado" class="btn btn-danger">Rechazado</button>
                        </div>
                      </div>
                    </form>
                  </div>
