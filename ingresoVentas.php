        ...
        <div class="right_col" role="main">                
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos usuario <small></small></h2>
                    ...
                    <form id="formIngresoVentas" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="canal" name="marca" class="form-control" required="">
                            <option value=""></option>
                            <option value="rem">REM</option>
                            <option value="boxisleep">Boxisleep</option> 
                          </select>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="colchon" placeholder="Colchón" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="precio" placeholder="Precio Colchón" required="required" type="text">
                        </div>
                      </div>                      
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="nombre" placeholder="Nombre" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="tipoDocumento" name="tipoDocumento" class="form-control" required="">
                            ...
                            <option value="Cédula de Extranjeria">Cédula extranjeria</option> 
                          </select>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="cedula" placeholder="Cédula" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="ciudad" placeholder="Nombre" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="canal" name="canal" class="form-control" required="">
                            ...
                            <option value="leadFacebook">Lead de Facebook</option> 
                          </select>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="contesto" name="contesto" class="form-control" required="">
                            <option value=""></option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="comentarios" name="comentarios" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
